 ...
 */
public class TaskFragmentPreConditionsTest extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public TaskFragmentPreConditionsTest() throws ClassNotFoundException {
    ...
    public void testPreconditions(){
        solo.waitForActivity(MainActivity.class);
        assertNotNull(FAButtonToDo);
        assertNotNull(FAButtonDoing);
        assertNotNull(FAButtonDone);
        assertNotNull(tvTabToDo);
        assertNotNull(tvTabDoing);
        assertNotNull(tvTabDone);
        assertNotNull(rlToDo);
        assertNotNull(rlDoing);
        assertNotNull(rlDone);
        assertNotNull(rvToDo);
        assertNotNull(rvDoing);
        assertNotNull(rvDone);
