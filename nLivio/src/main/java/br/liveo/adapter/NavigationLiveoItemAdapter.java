...
public class NavigationLiveoItemAdapter {
	...
	public NavigationLiveoItemAdapter(String title, int icon, int colorText, boolean header, int counter, int colorSelected, boolean removeSelector, boolean isVisible) {
		this.title = title;
		this.icon = icon;
